# Run create_data_extracts.R once to create data extracts for a certain year (2019 already is run and in the data folder)
...
# setwd("Documents/Professional/VandegriftHuting_consulting/nuestro_iowa/app/")
...
# Get transformed dataset for plots
